...
!insertmacro LANG_STRING STRING_HYPERV_NONETWORKSELECTED "Network is not selected. If there is no network, please use Hyper-V manager to create virtual switch and restart this setup."
