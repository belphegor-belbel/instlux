...
Function "ShowDistributionSelection"
  ...
  ${If} $0 == "x86_64"
    ...
    WriteIniStr ${DISTSELECT_INI} "Field 2" "ListItems" \
      "$R1openSUSE Leap 15.5|openSUSE Leap 15.4|openSUSE Leap 15.3|openSUSE Leap 15.2|openSUSE Leap 15.1|openSUSE Leap 15.0|openSUSE Tumbleweed|openSUSE Leap 42.3"
  ${Else}
